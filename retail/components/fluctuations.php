  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        Profit Fluctuation Report Filter
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
  ...
  <script>
    ...
    function generateReport() {
      ...
      if (confirm("Confirm Generating Report")) {
        ...
        $.ajax({
          url: 'api/generateFluctuation.php',
          type: 'POST',
          data:{
            type: type,
            date: date
    ...
    function reGenerateReport() {
      ...
      if (confirm("Confirm Re-Generating Report")) {
        ...
        $.ajax({
          url: 'api/reGenerateFluctuation.php',
          type: 'POST',
          data:{
            type: type,
            date: date
...
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <span class="typename">Monthly</span> Fluctuation v/s Impact Report
      </div>
      <div class="card-body">
        <div id="reportbody">

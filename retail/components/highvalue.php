  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        High Value Sales Report Filter
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
  ...
  <script>
    ...
    function reGenerateReport() {
      ...
      if (confirm("Confirm Re-Generating Report")) {
        ...
        $.ajax({
          url: 'api/reGenerateHighValue.php',
          type: 'POST',
          data:{
            type: type,
            date: date
...
<div class="row mt-3">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <span class="typename">Monthly</span> High Value Sales Report
      </div>
      <div class="card-body">
        <div id="reportbody">
